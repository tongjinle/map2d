System.register(['underscore'], function(exports_1, context_1) {
    ...
    exports_1("slashRange", slashRange);
    // 周围
    // near = line * 4个方向
    ...
    exports_1("nearSlashRange", nearSlashRange);
    // 圆圈
    ...
    exports_1("circleRange", circleRange);
    // 曼哈顿
    ...
    exports_1("manhattanRange", manhattanRange);
    // 获取两点之间的坐标
    ...
    exports_1("getBetween", getBetween);
    // 获取position的唯一主键
